...
#  не должен вводить время с часами меньше 0 и больше 23, и минутами больше 59 и меньше 0
            if hour < 0 or hour > 23:
                mb.showerror("Ошибка", " часы меньше 0 и больше 23")
            if minute < 0 or minute > 59:
                mb.showerror("Ошибка", "минуты больше 59 и меньше 0")
